...
export const Vstack_flex_a83b7647599da62b6dedbda0fbb7ddd4 = memo(({children}) => {
...
const reflex___state____state__cura___state____app_state = useContext(StateContexts.reflex___state____state__cura___state____app_state)
    ...
    return(
        jsx(RadixThemesFlex,{align:"start",className:"rx-Stack",css:({ ["&"] : ((reflex___state____state__cura___state____app_state.active_panel_rx_state_?.valueOf?.() === "insights"?.valueOf?.()) ? ({ ["color"] : "#818cf8", ["cursor"] : "pointer", ["align_items"] : "center", ["gap"] : "4px", ["flex"] : "1", ["justify_content"] : "center" }) : ({ ["color"] : "#4e4e6a", ["cursor"] : "pointer", ["align_items"] : "center", ["gap"] : "4px", ["flex"] : "1", ["justify_content"] : "center" })) }),direction:"column",onClick:on_click_8098789c671ed4c04af03cc1ef17cc30,gap:"3"},children)
    )
});
