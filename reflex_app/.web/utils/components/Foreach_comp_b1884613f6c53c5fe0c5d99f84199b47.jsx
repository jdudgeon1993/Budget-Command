...
export const Foreach_comp_b1884613f6c53c5fe0c5d99f84199b47 = memo(({children}) => {
    const reflex___state____state__cura___state____app_state = useContext(StateContexts.reflex___state____state__cura___state____app_state)



    return(
        Array.prototype.map.call(reflex___state____state__cura___state____app_state.tl_rows_rx_state_ ?? [],((r_rx_state_,index_bf3f57561d7fa0b2e069f42a7834ceba)=>(jsx(Fragment,{key:index_bf3f57561d7fa0b2e069f42a7834ceba},(() => {
  switch (JSON.stringify(r_rx_state_?.["rt"])) {
    ...
    case JSON.stringify("bill"):
      return jsx(RadixThemesFlex,{align:"start",className:"rx-Stack",css:({ ["padding"] : "8px 0 6px", ["borderBottom"] : "1px solid #25253533", ["opacity"] : ((r_rx_state_?.["pa"]?.valueOf?.() === "1"?.valueOf?.()) ? "0.6" : "1"), ["alignItems"] : "flex_start", ["gap"] : "10px", ["width"] : "100%" }),direction:"row",gap:"3"},jsx(RadixThemesBox,{css:({ ["width"] : "10px", ["height"] : "10px", ["borderRadius"] : "50%", ["background"] : ((r_rx_state_?.["pd"]?.valueOf?.() === "1"?.valueOf?.()) ? "#6868a2" : ((r_rx_state_?.["pa"]?.valueOf?.() === "1"?.valueOf?.()) ? "#6868a2" : "#f87171")), ["flexShrink"] : "0", ["marginTop"] : "2px", ["opacity"] : ((r_rx_state_?.["pa"]?.valueOf?.() === "1"?.valueOf?.()) ? "0.5" : "1") })},),jsx(RadixThemesFlex,{align:"start",className:"rx-Stack",css:({ ["gap"] : "1px", ["alignItems"] : "flex_start" }),direction:"column",gap:"3"},jsx(RadixThemesText,{as:"p",css:({ ["fontSize"] : "12px", ["color"] : ((r_rx_state_?.["pd"]?.valueOf?.() === "1"?.valueOf?.()) ? "#6868a2" : "#f0f0fa"), ["fontWeight"] : "500", ["textDecoration"] : ((r_rx_state_?.["pd"]?.valueOf?.() === "1"?.valueOf?.()) ? "line-through" : "none") })},r_rx_state_?.["lbl"]),jsx(RadixThemesText,{as:"p",css:({ ["fontSize"] : "12px", ["color"] : "#6868a2", ["fontFamily"] : "'Share Tech Mono', monospace", ["--default-font-family"] : "'Share Tech Mono', monospace" })},"Bill due")),jsx(RadixThemesFlex,{css:({ ["flex"] : 1, ["justifySelf"] : "stretch", ["alignSelf"] : "stretch" })},),jsx(RadixThemesText,{as:"p",css:({ ["fontSize"] : "12px", ["fontFamily"] : "'Share Tech Mono', monospace", ["--default-font-family"] : "'Share Tech Mono', monospace", ["color"] : ((r_rx_state_?.["pd"]?.valueOf?.() === "1"?.valueOf?.()) ? "#6868a2" : ((r_rx_state_?.["pa"]?.valueOf?.() === "1"?.valueOf?.()) ? "#6868a2" : "#f87171")), ["textDecoration"] : ((r_rx_state_?.["pd"]?.valueOf?.() === "1"?.valueOf?.()) ? "line-through" : "none") })},r_rx_state_?.["amt"]));
      break;
    default:
