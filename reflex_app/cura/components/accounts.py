                ...
                rx.vstack(
                    ...
                    rx.box(
                        ...
                        style={
                            ...
                            "background": rx.cond(
                                AppState.sheet_saving, "rgba(255,255,255,0.08)",
                                rx.cond(AppState.sheet_type == "in", GREEN,
                                rx.cond(AppState.sheet_type == "out", RED, ACCENT)),
                            ),
                            "color": "#fff", "border": "none",
                            "border_radius": "10px", "font_size": "13px",
                            "letter_spacing": "0.1em", "text_transform": "uppercase",
                            "cursor": "pointer", "text_align": "center",
                            "font_family": MONO, "font_weight": "700",
                            "box_shadow": rx.cond(
                                AppState.sheet_type == "in",
                                "0 4px 18px rgba(48,209,88,0.35)",
                                rx.cond(AppState.sheet_type == "out",
                                "0 4px 18px rgba(255,69,58,0.35)",
                                "0 4px 18px rgba(191,90,242,0.38)"),
                            ),
                            "_hover": {"opacity": "0.9"},
