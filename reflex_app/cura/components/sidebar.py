...
def _kpi(label: str, value: rx.Component, color: str = TEXT) -> rx.Component:
    return rx.box(
        rx.text(label, style={"font_size": "8px", "letter_spacing": "0.09em",
...
def _nav_item(label: str, panel: str, icon_path: str) -> rx.Component:
    ...
    return rx.box(
        rx.html(f'''<svg width="16" height="16" viewBox="0 0 24 24" fill="none"
            ...
            {icon_path}</svg>'''),
        rx.text(label, style={"font_size": "12px", "letter_spacing": "0.04em"}),
...
def sidebar() -> rx.Component:
    return rx.box(
        # ── Logo ─────────────────────────────────────────
        rx.box(
            rx.text("CURA", style={"font_size": "11px", "font_weight": "700",
                                    "letter_spacing": "0.18em", "color": ACCENT}),
            rx.text(AppState.month_display,
                    style={"font_size": "9px", "letter_spacing": "0.1em",
        ...
        rx.hstack(
            ...
            rx.text(AppState.month_display,
                    style={"font_size": "12px", "color": TEXT2, "flex": "1", "text_align": "center"}),
            rx.box(
                "→",
            ...
            style={
                ...
                "border_radius": "8px", "padding": "6px 4px", "align_items": "center",
            },
        ),
        ...
        rx.box(
            rx.hstack(
                ...
                rx.text("Add Transaction",
                        style={"font_size": "12px", "letter_spacing": "0.08em",
                               "text_transform": "uppercase"}),
                spacing="2",
            ),
            on_click=AppState.open_sheet,
            style={
                "margin": "0 12px 8px", "padding": "11px",
